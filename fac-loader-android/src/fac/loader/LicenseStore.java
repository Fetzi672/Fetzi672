...
public final class LicenseStore {
    private static final String PREF="fac_loader_license";
    private static final String KEY_ALIAS="fac_loader_license_key_v1";
    ...
    public static void invalidate(Context c){p(c).edit().putBoolean("verified",false).putBoolean("session_active",false).commit();}
